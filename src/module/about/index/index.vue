...
<style>
  ...
  #searchContent{font-size: 14px;}
  .seactent{border:1px solid #dcdce8; font-size:14px; margin-top:20px; padding:13px 40px; position:relative; background-color: #fbfbfb; border-radius: 8px;}
.seactent .tt{font-size: 21px}
